...
namespace GraphProcessorAPI.Migrations
{
    ...
    [Migration("20260910180726_Switched to datetime time in graph entity")]
    partial class Switchedtodatetimetimeingraphentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphProcessorAPI.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex(new[] { "UserId" }, "refresh_token_fk_index");

                    b.HasIndex(new[] { "Token" }, "refresh_token_unq")
                        .IsUnique();
            ...
            modelBuilder.Entity("GraphProcessorAPI.Models.RefreshToken", b =>
                {
                    b.HasOne("GraphProcessorAPI.Models.User", "User")
                        ...
                        .HasForeignKey("GraphProcessorAPI.Models.RefreshToken", "UserId")
                        .IsRequired()
